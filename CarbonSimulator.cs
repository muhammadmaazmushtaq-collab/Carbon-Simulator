...
namespace carbonsimulator
{
    public partial class Form1 : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (!rdoElectric.Checked && !rdoDiesel.Checked)
            {
                MessageBox.Show("Please select a Vehicle Type (Electric or Diesel)!", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
